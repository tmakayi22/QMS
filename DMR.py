...
from production import getOp, defectCategory, opsDict
from productionFunctions import removeStops, getLemma
...
def loadQN(path):
    ...
    print("{:>25} {:,} rows; {:>20}".format("Loading QN:", temp1.shape[0],"\tLambda Expression"),  end="\t")
    t.stop()
